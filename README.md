...
**Clinical Trial Synthetic Control Agent** is an advanced analytical and computational platform implementing Inverse Probability of Treatment Weighting (IPTW) & G-computation RWE matcher.
...
```bash
python cli.py --- <value> --demo <value> --file <value> --caliper <value>
```
...
- `--caliper`: Specifies input measurement or parameter value.
...
```bash
docker build -t clinical-trial-synthetic-control-agent .
docker run -p 8000:8000 clinical-trial-synthetic-control-agent
```
