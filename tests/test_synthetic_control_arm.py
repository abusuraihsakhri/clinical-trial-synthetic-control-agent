...
import pytest
from synthetic_control_arm.models import FrontierPayload, ExecutionStatus
from synthetic_control_arm.engine import FrontierDomainEngine
from synthetic_control_arm.agents import IPTWWeightEstimatorAgent, CovariateBalanceAuditorAgent, GComputationSurvivalEstimatorAgent, SyntheticControlCoordinator
from synthetic_control_arm.cli import main


def test_sub_agents():
    a1 = IPTWWeightEstimatorAgent()
    ...
    a2 = CovariateBalanceAuditorAgent()
    ...
    a3 = GComputationSurvivalEstimatorAgent()
...
def test_coordinator():
    coord = SyntheticControlCoordinator()
    ...
    assert "FDA Real-World Evidence (RWE) Guidance" in ans or "specifications" in ans
