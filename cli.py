...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="clinical-trial-synthetic-control-agent", description="Clinical Trial Synthetic Control Agent")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  CLINICAL TRIAL SYNTHETIC CONTROL AGENT")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Clinical Trial Synthetic Control Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Clinical Trial Synthetic Control Agent API server on http://{args.host}:{args.port}")
