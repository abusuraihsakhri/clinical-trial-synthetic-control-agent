"""
Data Models & Telemetry Definitions for SyntheticControl-Arm: Propensity Score & G-Computation Observational Matcher.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "FDA Real-World Evidence (RWE) Guidance"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
